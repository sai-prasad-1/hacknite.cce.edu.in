        ...
        <>
            <div className="flex items-start justify-center flex-col gap-4 p-10">
                ...
                <CustomFont description>
                    <p className="font-semibold py-2 max-w-[70%] ">Get ready for Hacknite, the ultimate 24-hour coding challenge! Whether you're a seasoned coder or just getting started,
                    ...
                    <p className="font-semibold py-2 max-w-[70%]">Mark your calendars for an adrenaline-fueled event like no other!</p>
                </CustomFont>
            </div>
        </>
    );
